...
\newcommand{\Llease}{L} % lease liability
...
\begin{figure}[h]
\centering
\IfFileExists{../analysis/figures/accor_case_study.png}{%
  \includegraphics[width=\textwidth]{../analysis/figures/accor_case_study.png}%
}{\fbox{Figure placeholder: accor\_case\_study.png}}
...
\label{app:proofs}
\IfFileExists{mathematical_appendix.tex}{\input{mathematical_appendix}}{\fbox{Appendix placeholder: mathematical\_appendix.tex not found.}}

\section{Theoretical Assumptions}
\label{app:assumptions}
\IfFileExists{theoretical_assumptions.tex}{\input{theoretical_assumptions}}{\fbox{Appendix placeholder: theoretical\_assumptions.tex not found.}}
